...
public class FindblocksProcedure extends FindblocksModElements.ModElement {
	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if (mcserv != null) {
			mcserv.getPlayerList().sendMessage(new StringTextComponent(FoundBlocks.size() + " Blocks added to list in radius " + radius));
		}
		SPHCodeProcedure.executeProcedure(dependencies, FoundBlocks); //Run SPH Code with foundblocks
	}
