...
import net.mcreator.findblocks.procedures.ResetBlocksCommandExecutedProcedure;
...
public class ResetBlocksCommand extends FindblocksModElements.ModElement {
	public ResetBlocksCommand(FindblocksModElements instance) {
		super(instance, 9);
	}
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("resetblocks")
	...
	private int execute(CommandContext<CommandSource> ctx) {
		...
		if (entity != null) {
			...
			});
			{
				...
				ResetBlocksCommandExecutedProcedure.executeProcedure($_dependencies);
			}
		}
		return 0;
	}
