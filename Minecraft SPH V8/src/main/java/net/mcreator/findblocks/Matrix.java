...
public class Matrix {
    ...
    public VectorObj mat_dot_vector(VectorObj b) {
		...
		data[0][0] = (this.getData()[0][0] * b.getData()[0][0]) + (this.getData()[0][1] * b.getData()[1][0]) + (this.getData()[0][2] * b.getData()[2][0]);
    	data[1][0] = (this.getData()[1][0] * b.getData()[0][0]) + (this.getData()[1][1] * b.getData()[1][0]) + (this.getData()[1][2] * b.getData()[2][0]);
    	data[2][0] = (this.getData()[2][0] * b.getData()[0][0]) + (this.getData()[2][1] * b.getData()[1][0]) + (this.getData()[2][2] * b.getData()[2][0]);
